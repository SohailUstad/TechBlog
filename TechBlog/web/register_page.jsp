...
<html>
    <head>
        ...
        <style>
            .banner-background{
                clip-path: polygon(25% 0, 100% 0, 100% 56%, 100% 98%, 81% 89%, 31% 100%, 0 93%, 0 0);
                            ...
                            <div class="card-body">
                                <form id="reg-form" action="RegisterServlet" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="user_about" rows="4" cols="30" type="text" class="form-control" id="about" placeholder="Enter something about yourself.."></textarea>
                                    </div>

                                    <div class="form-check">
                                        <input name="user_agreed" type="checkbox" class="form-check-input" id="exampleCheck1">
                                    ...
                                    <button type="submit" class="btn btn-primary" id="sybmit-btn">Register</button>
                                </form>
                            </div>
                        </div>
                    </div>
